...
from train_cddpm_mixed import train_diffusion_model_mixed
import torch

H5_FILENAME = "./data/your_data.hdf5"
IMAGES_LABELLED = None
IMAGES_UNLABELLED = None
IMG_LABELS = None
IMG_SIZE = 32
N_EPOCH = 200
BATCH_SIZE = 128
...
SAVE_IMAGES = True
SAVE_IMAGES_DIR = "./cddpm_mixed_images"
VAR_BETA1 = 1e-4
VAR_BETA2 = 0.02
DROP_PROB = 0.1
LOSS = "MSE"
...
train_diffusion_model_mixed(H5_FILENAME, IMAGES_LABELLED, IMG_LABELS, IMAGES_UNLABELLED, IMG_SIZE, N_EPOCH, BATCH_SIZE,
                      DIFFUSION_STEPS, DEVICE, N_CLASSES,
